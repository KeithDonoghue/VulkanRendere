...
VulkanRenderPass::VulkanRenderPass(VulkanDevice & theDevice, VulkanImage& depthImage, VulkanImage& colorImage) :
mDevice(theDevice),
...
VkRenderPassBeginInfo VulkanRenderPass::getBeginInfo()
{
